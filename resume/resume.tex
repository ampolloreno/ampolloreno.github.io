...
\footnotesize{Full stack software engineer. Working on control software to calibrate and characterize the quantum computer. Also worked on Rigetti's classical quantum simulator, compiler, customer facing code to access the quantum computer, and algorithms library to develop quantum algorithms. Work primarily done in Python and Common Lisp.}\\\multicolumn{2}{c}{} \\
...
\textbf{Languages}: Python, Common Lisp, Julia, SQL, \LaTeX, [Quil$\rangle$ 
